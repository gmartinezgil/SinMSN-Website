...
public abstract class SignInPanel extends Panel {
		...
		public final void onSubmit() {
			if (signIn(getUsername(), getPassword())) {
				...
				if (!continueToOriginalDestination()) {
					setResponsePage(ConnectingPage.class);//getApplication().getHomePage()
				}
			}
			else {
	 ...
	 */
	public SignInPanel(final String id, final String message) {
	 ...
	 * @see org.apache.wicket.Component#Component(String)
	 */
	public SignInPanel(final String id, final String message, final boolean includeRememberMe) {
		super(id);

		this.includeRememberMe = includeRememberMe;
		
		this.message = message;
		add(new Label("message", (message != null)?message:""));
